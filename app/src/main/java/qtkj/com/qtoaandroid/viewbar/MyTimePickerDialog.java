package qtkj.com.qtoaandroid.viewbar;
...
public class MyTimePickerDialog extends TimePickerDialog {
    ...
    private static MyTimePickerDialog newIntance(PickerConfig pickerConfig) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        dialog = new Dialog(getActivity(), com.jzxiang.pickerview.R.style.Dialog_NoTitle);
    ...
    */
    ...
    public static class Builder {
        ...
        public MyTimePickerDialog.Builder setType(Type type) {
            mPickerConfig.mType = type;
            return this;
        }

        public MyTimePickerDialog.Builder setThemeColor(int color) {
            mPickerConfig.mThemeColor = color;
            return this;
        }

        public MyTimePickerDialog.Builder setCancelStringId(String left) {
            mPickerConfig.mCancelString = left;
            return this;
        }

        public MyTimePickerDialog.Builder setSureStringId(String right) {
            mPickerConfig.mSureString = right;
            return this;
        }

        public MyTimePickerDialog.Builder setTitleStringId(String title) {
            mPickerConfig.mTitleString = title;
            return this;
        }

        public MyTimePickerDialog.Builder setToolBarTextColor(int color) {
            mPickerConfig.mToolBarTVColor = color;
            return this;
        }

        public MyTimePickerDialog.Builder setWheelItemTextNormalColor(int color) {
            mPickerConfig.mWheelTVNormalColor = color;
            return this;
        }

        public MyTimePickerDialog.Builder setWheelItemTextSelectorColor(int color) {
            mPickerConfig.mWheelTVSelectorColor = color;
            return this;
        }

        public MyTimePickerDialog.Builder setWheelItemTextSize(int size) {
            mPickerConfig.mWheelTVSize = size;
            return this;
        }

        public MyTimePickerDialog.Builder setCyclic(boolean cyclic) {
            mPickerConfig.cyclic = cyclic;
            return this;
        }

        public MyTimePickerDialog.Builder setMinMillseconds(long millseconds) {
            mPickerConfig.mMinCalendar = new WheelCalendar(millseconds);
            return this;
        }

        public MyTimePickerDialog.Builder setMaxMillseconds(long millseconds) {
            mPickerConfig.mMaxCalendar = new WheelCalendar(millseconds);
            return this;
        }

        public MyTimePickerDialog.Builder setCurrentMillseconds(long millseconds) {
            mPickerConfig.mCurrentCalendar = new WheelCalendar(millseconds);
            return this;
        }

        public MyTimePickerDialog.Builder setYearText(String year){
            mPickerConfig.mYear = year;
            return this;
        }

        public MyTimePickerDialog.Builder setMonthText(String month){
            mPickerConfig.mMonth = month;
            return this;
        }

        public MyTimePickerDialog.Builder setDayText(String day){
            mPickerConfig.mDay = day;
            return this;
        }

        public MyTimePickerDialog.Builder setHourText(String hour){
            mPickerConfig.mHour = hour;
            return this;
        }

        public MyTimePickerDialog.Builder setMinuteText(String minute){
            mPickerConfig.mMinute = minute;
            return this;
        }

        public MyTimePickerDialog.Builder setCallBack(OnDateSetListener listener) {
