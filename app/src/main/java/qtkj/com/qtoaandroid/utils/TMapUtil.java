...
import static qtkj.com.qtoaandroid.utils.BitmapUtil.bmEnd;
import static qtkj.com.qtoaandroid.utils.BitmapUtil.bmStart;
...
public class TMapUtil {
    ...
    private static TMapUtil INSTANCE = new TMapUtil();
    ...
    public static TMapUtil getInstance() {
        return INSTANCE;
    }
    public static TMapUtil getNewInstance() {
        return new TMapUtil();
    }
