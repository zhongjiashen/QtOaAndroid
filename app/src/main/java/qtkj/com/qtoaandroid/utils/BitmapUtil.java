...
public class BitmapUtil {
    ...
    public static void init() {
        bmArrowPoint = BitmapDescriptorFactory.fromResource(R.mipmap.ic_point);
        bmStart = BitmapDescriptorFactory.fromResource(R.mipmap.ic_start);
        bmEnd = BitmapDescriptorFactory.fromResource(R.mipmap.ic_end);
